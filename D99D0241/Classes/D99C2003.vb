...
Public Class D99C2003
    ...
    Public Sub New(ByVal formParent As Form, ByRef isOpen As Boolean)
        If Not AllOpenForm(formParent.Name, "D99F0002", "FormParent") Then
            isOpen = True
            Exit Sub
        End If
        InitializeComponent()
    ...
    Public Sub PrintReport(ByVal MainReportName As String, Optional ByVal MainReportCaption As String = "Crystal Report", Optional ByVal ModePrint As ReportModeType = ReportModeType.lmPreview, Optional ByVal PrinterName As String = "")
        Dim FormPreview As New D99F0002
        Try
            ...
            If gbFlagPrint1 = False Then
                ...
                Select Case ModePrint
                    Case ReportModeType.lmPreview
                        ...
                        FormPreview.FormParent = _formParent
                        FormPreview.Show(_formParent) 'Dialog() 'Show bị lỗi
    ...
    Private Sub Print()
        ...
        If _formParent IsNot Nothing Then ConnectReportServer(_formParent.Name, sConnectString)
        Try
            ...
            'MessageBox.Show("SetDataSource: " & nRowMaximum)
        ...
        Catch ex As Exception
            StrError = "Set data source error." & vbCrLf & "(" & ex.Message & ")" & vbCrLf & ex.Source
            GoTo Err_Handlling
        End Try
...
NextParaMain:
        ...
        If gsPrinterName1 <> "" Then 'Nếu có chọn máy thì lấy máy đó ngược lại lấy Default
            ...
            'MessageBox.Show("rpt1.PrintOptions.PrinterName = " & gsPrinterName1)
            If giPaperSizes > -1 Then rpt1.PrintOptions.PaperSize = giPaperSizes
            'rpt1.PrintOptions.PaperOrientation = PaperOrientation.DefaultPaperOrientation
