...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtLastKey
        '
        Me.txtLastKey.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.249998!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
    ...
    Private Sub D99F1111_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If gnNewLastKey = 0 Then
            ...
            '***************************
            'Update 06/02/2015: theo Incident 71030 
            Dim sSQL As String = "----Luu New Last Key co Refesh cho So phieu tu dong" & vbCrLf
            sSQL &= SQLStoreD91P9111("", "", "", "", "", 1, 1, "", _KeyString, 1, 0, 0, 0, _tableName)

            Dim dt As DataTable
            dt = ReturnDataTable(sSQL)
            If dt.Rows.Count > 0 Then
                gnNewLastKey = L3Int(dt.Rows(0).Item("Lastkey").ToString) + 1
            Else
                gnNewLastKey = 1
            End If
