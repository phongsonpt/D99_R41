...
#End Region
    ...
    Private Sub D91F5555_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dtPeriod = ReturnDataTable(SQLGeneral.SQLStoreD91P5566(1, _moduleID, 1))
    ...
    Private Sub Loadlanguage()
        Me.Text = rL3("Khoa_soF") & " - " & Me.Name.Replace("D91", "D" & _moduleID) & UnicodeCaption(gbUnicode) 'TÁo kù mìi - D90F5556"
        '================================================================ 
        tdbg.Columns(COL_IsUsed).Caption = rL3("Chon")
        tdbg.Columns(COL_Period).Caption = rL3("Ky_muon_khoa") '"Kỳ muốn khóa" '
        '================================================================ 
        btnCreate.Text = "&" & rL3("Khoa_so")
    ...
    Private Sub LoadTDBGrid()
        ...
        Dim sSQL As String = SQLGeneral.SQLStoreD91P5566(1, _moduleID, 0)
